...
<body>
  ...
  <nav class="navbar navbar-expand-lg sticky-top py-3 shadow navbar-light bg-light mb-3" style="z-index: 1">
    <div class="container">
        ...
        <ul class="navbar-nav ml-auto">
          <?php if(!$session->get('user_id')): ?>
            <li class="nav-item ml-3">
              <a href="<?= base_url('users/users/signup') ?>" class="nav-link <?= ($title == 'signup') ? 'active' : ''; ?>">Signup</a>
            </li>
            <li class="nav-item ml-3">
              <a href="<?= base_url('users/users/login'); ?>" class="nav-link <?= ($title == 'login') ? 'active' : ''; ?>">Login</a>
            </li>
