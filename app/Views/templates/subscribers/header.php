...
<nav class="navbar navbar-expand-lg sticky-top py-3 shadow navbar-light bg-light mb-4" style="z-index: 1">
    <div class="container">
      ...
      <form class="form-inline my-2 my-lg-0 ml-3" action="<?= base_url('search/search'); ?>" method="get" id="searchForm">
        ...
        <ul class="navbar-nav ml-auto">
          ...
          <?php elseif($session->get('user_id')): ?>
            ...
            <li class="nav-item ml-3"><a href="<?= base_url() ?>/dashboard" class="nav-link">Dashboard</a></li>
          <li class="nav-item ml-3"><a href="<?= base_url() ?>/videos" class="nav-link">Videos</a></li>
          <li class="nav-item ml-3"><a href="<?= base_url() ?>/history" class="nav-link">History</a></li>
  ...
  <nav class="navbar w-100 flex-row fixed-bottom navbar-light bg-light d-lg-none d-md-block d-sm-block" id="nav">
    <ul class="navbar-nav justify-content-between align-items-center" id="ulNav">
        ...
        <li class="nav-item ml-3">
          <a href="<?= base_url('history'); ?>" class="list-group-item color-black">
