...
<nav class="navbar navbar-expand-lg sticky-top py-3 shadow navbar-light bg-light px-sm-2" style="z-index: 3">
    <div class="container">
        ...
        <ul class="navbar-nav ml-auto">
          ...
          <?php elseif($session->get('user_id')): ?>
            <li class="nav-item ml-3">
              <a href="<?= base_url() ?>/studio/create/create" class="nav-link <?= ($title == 'Create') ? 'active' : ''; ?>">Create</a>
            </li>
...
<nav class="navbar w-100 flex-row fixed-bottom navbar-light bg-light d-lg-none d-md-block d-sm-block">
    <ul class="navbar-nav justify-content-between align-items-center" id="ulNav">
        ...
        <li class="nav-item ml-3">
          <a href="<?= base_url() ?>/dashboard" class="list-group-item <?= ($title == 'Dashboard') ? 'color-red' : 'color-black'; ?>"><i class="fas fa-tachometer-alt mr-2"></i></a>
        </li>

        <li class="nav-item ml-3">
        <a href="<?= base_url() ?>/videos" class="list-group-item <?= ($title == 'Videos') ? 'color-red' : 'color-black'; ?>"><i class="fas fa-video mr-2"></i></a>
        </li>
    </ul>
  </nav>
  ...
  <div class="col-md-2 m-0 p-0 d-none d-lg-block" id="content">
    <aside class="shadow-lg">
      ...
      <a href="<?= base_url(); ?>" class="list-group-item <?= ($title == 'Home') ? 'active-list color-red' : 'color-black'; ?>">
        ...
        <a href="<?= base_url() ?>/dashboard" class="list-group-item <?= ($title == 'Dashboard') ? 'active-list color-red' : 'color-black'; ?>">
        <i class="fas fa-tachometer-alt mr-2"></i>Dashboard</a>
        <a href="<?= base_url() ?>/videos" class="list-group-item <?= ($title == 'Videos') ? 'active-list color-red' : 'color-black'; ?>">
        <i class="fas fa-video mr-2"></i>Videos</a>
      </ul>
    </aside>
  </div>
